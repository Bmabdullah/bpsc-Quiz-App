    ...
    func getpostDictionaryData() {
        ...
        postDatawithNSDictionary(urlString:apiUrl,parameters:param,baseURL: "") { (jsonDict) in
            do {
                ...
                if self.usenameTextField.text != nil && self.passwordTextField.text != nil{
                    
                    if responseModel.failedResponse == nil && responseModel.successResonse?.token != nil {
                        ...
                        print(responseModel.failedResponse as Any)
